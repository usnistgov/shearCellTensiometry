...
class vidInfo:
    ...
    def consolidateDroplets(self) -> None:
        ...
        for num in dropNums:
            ...
            endpoints.append({'dropNum':num, 'firstY':firstY, 'lastY':lastY, 'vinit':vinit, 'vfinal':vfinal, 'tinit':tinit, 'tfinal':tfinal})
            ...
            if i>0:
                ...
                while iprev>=0:
                    try:
                        ...
                        endpoints.loc[i,'tinit']>endpoints.loc[iprev,'tfinal']:
                            # opposite sign velocities and start/end on same edge and enter after the droplet left: same droplet
